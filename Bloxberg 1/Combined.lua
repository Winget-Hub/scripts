-- Combined from Clean/Loadstring.lua and Clean/Main.lua.
-- Loadstring.lua is inlined below so Main.lua uses the same Rayfield library without fetching sirius.menu/rayfield.
...
-- Begin recovered Bloxberg script.
