-- Deobfuscated from scripts/Skids/server38/Dirty/Main.lua
-- Original dirty file was protected with MoonSec V3.
-- Runtime recovery attempted by scripts/Unhiding/deobfuscate_server38.py.

-- Decoded loader URL: https://raw.githubusercontent.com/rndmq/Serverlist/refs/heads/main/source.lua.txt
